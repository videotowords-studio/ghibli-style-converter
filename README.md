...
一个本地可运行、之后可推到 GitHub 和 Cloudflare 的小学生辅助创作网站。用户注册后获得 100 积分，可以使用作文宝、吉卜力转绘、周工解梦、心愿墙、神秘积分抽奖，并查看自己的生成记录。
...
- 后端：Cloudflare Worker 提供登录注册、作文生成、图片转绘、解梦、心愿墙、积分抽奖和生成记录接口
- 数据库：Cloudflare D1 存储邮箱账号、密码哈希、积分、生成记录和心愿墙留言
